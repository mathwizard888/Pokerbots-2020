...
class Player(Bot):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        # potential pair adjustment
        for card in board_cards:
            board_strength = 0.8*board_strength+0.2*(0.4+board_strength*0.6)
        ...
        for suit in 'cdhs':
            ...
            if street > 0 and board_count >= 2 and board_strength < 0.942:
        ...
        if pot_odds < strength:
            if random.random() < strength and RaiseAction in legal_actions:
